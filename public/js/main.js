...
const elsWithanimations = Array.from(
...
function inDarkMode() {
  ...
  root.style.setProperty(
    '--filter-img',
    'invert(98%) sepia(79%) saturate(3323%) hue-rotate(186deg) brightness(85%) contrast(89%)',
  );
}
function inLightMode() {
  ...
  root.style.setProperty(
    '--filter-img',
    'invert(20%) sepia(46%) saturate(727%) hue-rotate(242deg) brightness(94%) contrast(93%)',
  );
}
